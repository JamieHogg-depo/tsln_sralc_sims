...
#' @param alpha_survey magnitude of affect for unit-level survey covariate
#' @param alpha_nonsurvey magnitude of affect for unit-level nonsurvey covariate
#' @param gamma magnitude of affect for area-level covariates
generateCENSUS <- function(seed, 
						   alpha_survey,
						   alpha_nonsurvey,
						   gamma,
						   QaS){
